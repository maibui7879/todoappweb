...
const TasksPage = () => {
  ...
  const { data: tasks = [] } = useQuery({
    queryKey: ["tasks", today, isCompleted],
    queryFn: () => taskApi.getTasks(today, isCompleted),
  });
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F4F6FB]">
      ...
      {/* HERO - nền tím nhạt, chiều rộng thu hẹp */}
      <div className="bg-[#ECEDF8]">
        <div className="w-full px-16 py-10 grid grid-cols-[1fr,1.3fr] gap-8 items-center">
          ...
          <div className="relative h-[300px]">
            ...
            {/* Card nhỏ - Get things done (đè lên góc phải card lớn) */}
            <div
            ...
            {/* Bulb - đè lên góc trên phải card nhỏ */}
            <div
